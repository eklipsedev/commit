      ...
      <Container className="space-y-8 md:space-y-10">
        ...
        {block.body && (
          <div className="grid md:grid-cols-2 md:gap-x-14">
            ...
            <p
              className={
                block.collapseLineBreaksOnMobile
                  ? 'whitespace-normal text-[1.5rem] font-normal leading-[1.2] md:whitespace-pre-line md:text-[2rem]'
                  : 'whitespace-pre-line text-[1.5rem] font-normal leading-[1.2] md:text-[2rem]'
              }
